...
function landingHtml(did: string, host: string): string {
  ...
  return [
    ...
    "@media (max-width:760px){main{padding-top:30px}.grid,.flow{grid-template-columns:1fr}.arrow{display:none}.logo{width:132px}h1{font-size:2.5rem}footer{flex-direction:column;align-items:flex-start}footer .meta{text-align:left}}",
    "</style>",
    "</head>",
    "<body>",
    "<main>",
    ...
    "</div>",
    "<div class=\"meta\">",
    "<a href=\"https://ink.tulpa.network\">ink.tulpa.network</a><br>",
    "<a href=\"https://github.com/Ad-Astra-Computing/ink/tree/main/examples/reference-receiver\">Source on GitHub</a>",
    "</div>",
    "</footer>",
    "</main>",
    "</body>",
