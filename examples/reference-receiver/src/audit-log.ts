...
export interface AuditEntryInput {
  ...
  sender: string;
  intent: string;
  verdict: "accepted" | "rejected_rate_limit" | "rejected_schema" | "rejected_signature" | "rejected_unsupported_intent" | "rejected_oversize" | "rejected_utf8" | "rejected_encryption" | "error";
  errorCode?: string;
  now?: () => number;
}
