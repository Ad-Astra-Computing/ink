...
| `card_response_invalid` | The card response's Content-Type is missing, ambiguous, not `application/json` or non-utf-8-charset, or its Content-Length declares a body over the 64 KiB cap. |
